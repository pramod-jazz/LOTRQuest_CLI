...
/**
 * Finally, the top of the stack. This is the class that is invoking the command. Looks simple from up here, doesn't it?
 */
public class GameController extends GameControlBase {
    ...
    private final Integer currentLevelSuccess = 0;
    ...
    public void help() throws Exception {
        GameController.logger.info("Watch me invoke the map command");
        final String message = executeCommand(Command.HELP, new HelpCommandParams("Helping World"));
        GameController.logger.info("Message: " + message);
    }

    public void map(final Player player) throws Exception {
        GameController.logger.info("Watch me invoke the map command");
        final String message = executeCommand(Command.MAP, new MapCommandParams(player.getCurrentLevel()));
        GameController.logger.info("Message: " + message);
    }

    public void quit() throws Exception {
        GameController.logger.info("Watch me invoke the quit command");
        final String message = executeCommand(Command.QUIT, new QuitCommandParams("Quitting game"));
        GameController.logger.info("Message: " + message);
    }

    public void profile(final Player player) throws Exception {
        GameController.logger.info("Watch me invoke the profile command");
        final String message = executeCommand(Command.PROFILE,
    ...
    public void continueGame1() throws Exception {
        GameController.logger.info("Watch me invoke the contine command");
        final String message = executeCommand(Command.CONTINUE, new ContinueCommandParams("Continuing game!"));
        GameController.logger.info("Message: " + message);
    }

    public void resume() throws Exception {
        GameController.logger.info("Watch me invoke the resume command");
        final String message = executeCommand(Command.RESUME, new ResumeCommandParams("Resuming Game"));
        GameController.logger.info("Message: " + message);
    }
